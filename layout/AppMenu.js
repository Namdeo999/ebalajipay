    ...
    const model = [
        {
            ...
            items: [
                ...
                // { label: 'Dashboard 2', icon: 'pi pi-fw pi-home', to: '/dashboard' }
            ]
        },
        {
            label: 'Coupons',
            items: [
                { label: 'P-Coupons', icon: 'pi pi-fw pi-id-card', to: '/pcoupons' },
                { label: 'E-Coupons', icon: 'pi pi-fw pi-check-square', to: '/ecoupons' },
        ...
        },
        {
            ...
            items: [
                { label: 'Bank Account', icon: 'pi pi-fw pi-id-card', to: '/bank_account' },
                { label: 'Wallet', icon: 'pi pi-fw pi-check-square', to: '/wallet' },
